...
#ifndef CTTRANSIT_SWIFT_H
#define CTTRANSIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="cttransit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC9cttransit11AppDelegate")
...
SWIFT_CLASS("_TtC9cttransit17MainFlutterWindow")
